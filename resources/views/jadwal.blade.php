<x-app-layout>
    <head>
        <meta charset="utf-8">
        <title>Jadwal PPDB Surabaya 2024</title>
    ...
    <body>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Jadwal Pelaksanaan PPDB Surabaya 2024') }}
            </h2>
        </x-slot>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td>Daftar Ulang di SMA Negeri Tujuan</td>
                                            <td>XX Bulan 2024</td>
                                            <td>XX.XX WIB</td>
                                            <td>SMA Negeri yang dituju</td>
                                        </tr>
                                        <tr>
                                            <td>6</td>
                                            <td>Pengumuman Pemenuhan Pagu</td>
                                            <td>XX Bulan 2024</td>
                                            <td>XX.XX WIB</td>
                                            <td>Internet online</td>
                                        </tr>
                                        <tr>
                                            <td>7</td>
                                            <td>Daftar Ulang Pemenuhan Pagu</td>
                                            <td>XX Bulan 2024</td>
                                            <td>XX.XX WIB</td>
                                            <td>SMA Negeri yang dituju</td>
                                        </tr>
